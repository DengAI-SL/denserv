        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Edit Patient Report Form</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('global.patient_report.title_singular') }}
            <em>{{ trans('global.patient.title_singular') }} : <b>{{$patient->name}}</b> </em>
        </div>

        <div class="card-body">
            <form action="{{ route("user.patient_reports.update",[$patient->id]) }}" method="POST"
